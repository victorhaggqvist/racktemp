...
sudo echo "<?php $db_conf=new stdClass; $db_conf->host='localhost'; $db_conf->db='racktemp'; $db_conf->user='racktemp'; $db_conf->pass='TGjJOcDT8gRnN0LqQ7gL'; ?>" > lib/dbconfig.php
